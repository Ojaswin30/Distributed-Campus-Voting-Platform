...
# 2. Start Main Election Frontend in separate window
Write-Host "[2/3] Starting Main Election Portal on http://localhost:5173 ..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$RootDir\frontend'; npm run dev"

# 3. Start Superadmin Portal in separate window
Write-Host "[3/3] Starting Superadmin Portal on http://localhost:5174 ..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$RootDir\frontend'; npm run superadmin"
...
Write-Host "  * Main Election UI:   http://localhost:5173           " -ForegroundColor White
Write-Host "  * Superadmin Portal:  http://localhost:5174           " -ForegroundColor White
Write-Host "========================================================" -ForegroundColor Green
Write-Host ""
